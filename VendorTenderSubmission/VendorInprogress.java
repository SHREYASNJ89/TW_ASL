...
public class VendorInprogress extends BasePage {
	...
	public VendorInprogress(WebDriver driver)
	       {
		super(driver);
	       }
	       
	       public  void inprogress(String an) throws InterruptedException
	       {
	    	   driver.switchTo().defaultContent();
	    	   waitForElementToAppear(By.xpath("//frame[@name='left']"));
